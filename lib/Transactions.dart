...
class _TransactionsState extends State<Transactions> {
  ...
  Future<void> _getStoredData() async { //Get store id, name etc
      ...
      body:
          Column(
            ...
            children: <Widget>[
                                                    ...
                                                    MaterialPageRoute(builder: (context) => OrderInfo(),
                                                      settings: RouteSettings(
                                                        arguments: OrderInfoArguments(
                                                            appState.getUserHistoryJson()[index].time,
                                                            appState.getUserHistoryJson()[index].userName,
                                                            appState.getUserHistoryJson()[index].userId,
                                                            appState.getUserHistoryJson()[index].topupId,
                                                            appState.getUserHistoryJson()[index].amount,
                                                            appState.getUserHistoryJson()[index].remark,
                                                            appState.getUserHistoryJson()[index].cleared),
                                                      ),
                                                    ),
                                                  );
                                                },
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: <Widget>[
                                                      ...
                                                      Row(
                                                        ...
                                                        children: <Widget>[
                                                          Text(
                                                            'RM ' + appState.getUserHistoryJson()[index].amount.toStringAsFixed(2),
                                                          ...
                                                          Text(
                                                            StringUtils.capitalize(appState.getUserHistoryJson()[index].remark),
                                                            style: Theme.of(context).textTheme.subtitle,
                                                          ),
                                                        ],
                                                      ),
                                                      Chip(
                                                        backgroundColor: appState.getUserHistoryJson()[index].cleared == 'cleared' ? Color(0xff03da9d).withAlpha(30) : Theme.of(context).primaryColor.withAlpha(30),
                                                        shape: RoundedRectangleBorder(
                                                        ...
                                                        label: Text(
                                                          StringUtils.capitalize(appState.getUserHistoryJson()[index].cleared),
                                                          style: TextStyle(color:
                                                          appState.getUserHistoryJson()[index].cleared == 'cleared' ? Color(0xff03da9d) : Theme.of(context).primaryColor),
                                                        ),
                                                      ),
                                                      Expanded(
                                                        child: Column(
              ...
              Center(
                child: Container(
                  child: Text("No response from server. Please try again later."),
                )
              )
            ],
          )
